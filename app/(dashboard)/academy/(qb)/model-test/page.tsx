...
const AcademyModelTestPage = () => {
    ...
    useEffect(() => {
        setBreadcrumbList([
            ...
            { title: 'Manage', link: '/academy/model-test' },
        ]);
    ...
    useEffect(() => {
        startTransition(async () => {
            const response = await loadAcademicModelTest(currentPage, pageSize, subjectId, instituteId);
    ...
    useEffect(() => {
        startTransition(async () => {
            const response = await loadAcademicInstitute(1, 1000);
