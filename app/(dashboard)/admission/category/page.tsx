...
import { loadAdmissionCategory } from "@/app/_services/admission/admission-category-service";
...
const AdmissionCategoryPage = () => {
    ...
    useEffect(() => {
        setBreadcrumbList([
            { title: 'Home', link: '/' },
            { title: 'Admission Cat', link: '/admission/category' },
            { title: 'Manage', link: '/admission/category' },
        ]);
    ...
    useEffect(() => {
        startTransition(async () => {
            const response = await loadAdmissionCategory(currentPage, pageSize, segment);
